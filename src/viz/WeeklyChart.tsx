...
const WeeklyChartContent: React.FC<WeeklyChartContentProps> = ({ data }) => {
  ...
  const barData = Object.entries(data).map(([key, obj]) => ({
    weekday: key.substring(0, 1),
    ...obj,
    meanDistance: obj.meanDistance / 1000,
    confidenceDistance: (zScore * obj.stdDevDistance) / 1000,
  }));
...
export const WeeklyChart = () => {
  ...
  return <WeeklyChartContent data={data} />;
};
